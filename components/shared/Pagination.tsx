...
const Pagination = ({ pageNumber, isNext }: Props) => {
  ...
  return (
    <div className="mt-4 flex w-full items-center justify-center gap-2">
      ...
      >
        <p className="body-medoum text-dark200_light800">Prev</p>
      </Button>

      <div className="bg-primary-500 flex justify-center items-center rounded-md px-3.5 py-2">
        <p className="body-semibod text-light-900">{pageNumber}</p>
      </div>
      ...
      <Button
        ...
        className="light-border-2 border btn flex min-h-[36px] items-center justify-center gap-2"
      >
        <p className="body-medoum text-dark200_light800">Next</p>
      </Button>
    </div>
  );
};
